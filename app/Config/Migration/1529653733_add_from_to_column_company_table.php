<?php
class AddFromToColumnSectionTable extends CakeMigration {
 ...
 */
	public $migration = array(
		'up' => array(
			'create_table' => array(
				...
				'request_details' => array(
					...
					'is_season_ticket' => array('type' => 'boolean', 'null' => true, 'default' => '0'),
					'indexes' => array(
						'PRIMARY' => array('column' => 'id', 'unique' => 1),
					),
					'tableParameters' => array('charset' => 'utf8', 'collate' => 'utf8_general_ci', 'engine' => 'MyISAM'),
		...
		'down' => array(
			'drop_table' => array(
				'sections', 'confirm_months', 'departments', 'request_details', 'requests', 'transportations', 'travel_sections', 'users'
			),
		),
	);

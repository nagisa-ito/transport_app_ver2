<?php
class AddRequestDetailsIsNoRequestColumn extends CakeMigration {
 ...
 */
	public $migration = array(
		'up' => array(
			'create_table' => array(
				...
				'request_details' => array(
					...
					'is_no_request' => array('type' => 'boolean', 'null' => true, 'default' => NULL),
					'indexes' => array(
						'PRIMARY' => array('column' => 'id', 'unique' => 1),
					),
					'tableParameters' => array('charset' => 'utf8', 'collate' => 'utf8_general_ci', 'engine' => 'MyISAM'),
		...
		'down' => array(
			'drop_table' => array(
				'confirm_months', 'departments', 'request_details', 'requests', 'transportations', 'users'
			),
		),
	);
